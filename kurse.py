...
def planner():
    #用来完成对planner的设置, 次function暂且作废
    
    while True:
        try: 
            if driver.find_element('xpath','/html/body/table[3]/tbody/tr[15]/td[1]/a'):
                driver.find_element('xpath','/html/body/table[3]/tbody/tr[15]/td[1]/a').click()
                print('got it')
                break
        except:
            print('waiting for you to push')
    #等你push完对duo mobile的登录，点击对应semester的reg option
            
    driver.find_element('xpath','/html/body/center[1]/table[2]/tbody/tr[2]/td[2]/a').click()
    driver.find_element('xpath','/html/body/table[4]/tbody/tr[8]/td/a').click()
